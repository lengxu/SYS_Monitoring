    ...
    var doevent = function *() {
        ...
        yield monitorprojects.map(function *(item) {
            ...
            if (response.statusCode!=200) {
                ...
                monitorlog.responsemessage=response.body;
                ...
                //循环项目人员
                yield WechatUserModel.findBySendAllProjectStatus().map(function *(wechatuseritem) {
            ...
            monitorlog.responsestatus=response.statusCode;

            yield thunkify(monitorlog.save, MonitorlogModel);


            //更新网站状态
            yield thunkify(ProjectModel.updateProjectMonitorInfo, ProjectModel)(item.id,response.statusCode);

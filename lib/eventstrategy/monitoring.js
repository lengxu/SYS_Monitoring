        ...
        )
        {
            ...
            yield wechatusers.map(function *(wechatuseritem) {
                ...
                if (wechatuseritem.status == 0) {
                    ...
                    //发送语音通知
                    console.log(wechatusers.userinfo.name);
                    console.log(projectitem.name);
                    console.log(wechatusers.userinfo.tel);
                    alidayuAPI.sendsinglecall(wechatusers.userinfo.name,projectitem.name,wechatusers.userinfo.tel);

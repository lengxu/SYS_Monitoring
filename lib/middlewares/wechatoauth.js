...
var client = new OAuth(config.wechatinfo.appid, config.wechatinfo.appsecret),
    apiclient=new WechatAPI(config.wechatinfo.appid, config.wechatinfo.appsecret);
...
exports.view = function() {
    return function*(next) {
        ...
        //判断是否关注过公众号
        var result = yield *  apiclient.getUser(this.session.wechatUserInfo.openid);
        console.log(apiclient);
        console.log(this.session.wechatUserInfo.openid);
        console.log(result);
